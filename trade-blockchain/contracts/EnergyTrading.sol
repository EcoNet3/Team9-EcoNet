...
EnergyTransaction[] public transactions;
 ...
 if (sellOrder.seller != address(0) && sellOrder.executed == false && sellOrder.energyQuantity == buyOrder.energyQuantity && sellOrder.price <= buyOrder.price) {
 ...
 require(transaction.buyer == msg.sender || transaction.seller == msg.sender, "Unauthorized");
